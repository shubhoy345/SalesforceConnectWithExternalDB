...
public class CrudOperationWithLead {
    ...
    public static void queryLeads() {
        ...
        try {
            ...
            String uri = baseUri + "/query?q=Select+Id+,+FirstName+,+LastName+,+Company+From+Lead+Limit+1";
            ...
            if (statusCode == 200) {
                ...
                try {
                    ...
                    for (int i = 0; i < j.length(); i++){
                    	...
                    	String insertSql="insert into lead values("+"lead_seq.nextval,'"+leadId+"'"+",'"+leadFirstName+"','"+leadLastName+"','"+leadCompany+"'"+")";
        ...
        System.out.println("\n_______________ Lead INSERT _______________");
           ...
           // to fetch dbid from trainrider table
            ...
            Connection con=DriverManager.getConnection("jdbc:oracle:thin:@localhost:1521:xe","shubhu","shubhu");  
         	...
         	Statement stmt=con.createStatement();  
         	String selectSql="select id from lead where leadid='"+leadid+"'";
            ...
            lead.put("trainrider__LeadId__c", leadid);
